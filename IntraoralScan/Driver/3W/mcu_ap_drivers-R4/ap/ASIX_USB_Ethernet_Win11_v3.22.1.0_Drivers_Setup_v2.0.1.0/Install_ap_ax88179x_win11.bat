...
"%~dp0/PsExec64.exe" -i -s -realtime /accepteula pnputil -i -a "%~dp0/program files/ASIX\ASIX_USB_Ethernet_Win11_Drivers/64-bit/AxUsbEth.inf"
"%~dp0/program files/ASIX\ASIX_USB_Ethernet_Win11_Drivers/64-bit/dpinst.exe" /PATH "%~dp0/program files/ASIX\ASIX_USB_Ethernet_Win11_Drivers/64-bit/" /F /Q /A
xdevcon.exe rescan
...
pnputil -i -a "%~dp0/program files/ASIX\ASIX_USB_Ethernet_Win11_Drivers/64-bit/AxUsbEth.inf"
"%~dp0/program files/ASIX\ASIX_USB_Ethernet_Win11_Drivers/64-bit/dpinst.exe" /PATH "%~dp0/program files/ASIX\ASIX_USB_Ethernet_Win11_Drivers/64-bit/" /F /Q /A
:FINISHPOS
